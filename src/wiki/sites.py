...
class WikiSite:
    ...
    def __init__(self, name='wiki'):
        ...
        self.add_to_archive_view = getattr(self, "add_to_archive_view", article.AddToArchive.as_view())
    ...
    def get_article_path_urls(self):
        urlpatterns = [
            ...
            url(r'^(?P<path>.+/|)_add-to-archive/$', self.add_to_archive_view, name='add_to_archive'),
